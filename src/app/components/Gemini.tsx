...
import { MovingBorderDisplay } from "./MovingBorders";
  ...
  return (
    <div className={cn("sticky top-20", className)}>
      <p className="text-lg md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300">
        {title || `Lets make great work together!`}
      </p>
      <p className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
        {description ||
          `Drop your contact details for me to get in touch with you!`}
      </p>
      <div className="w-full h-[905px] -top-60 md:-top-40  flex items-center justify-center bg-transparent absolute z-40 ">
      <button className="font-bold bg-white rounded-full md:px-4 md:py-2 px-2 py-1 md:mt-24 mt-8 z-30 md:text-base text-black text-xs  w-fit mx-auto " onClick={handleClick}>
          Get in touch
        </button> </div> 
        {isClicked && <SignupFormDisplay />}
...
export function GoogleGeminiEffectDisplay() {
